...
entry:
  ...
  %0 = insertvalue { ptr, ptr } undef, ptr %local, 0
  %closure-arg = insertvalue { ptr, ptr } %0, ptr %local2, 1
  %1 = call i64 @exp-tail(i64 2, i64 3, { ptr, ptr } %closure-arg)
...
entry:
  %"closure-env:local" = extractvalue { ptr, ptr } %closure-env, 0
  %"closure-env:local-ptr" = alloca ptr, align 8
  store ptr %"closure-env:local", ptr %"closure-env:local-ptr", align 8
  %0 = load ptr, ptr %"closure-env:local-ptr", align 8
  %"closure-env:local2" = extractvalue { ptr, ptr } %closure-env, 1
  %"closure-env:local2-ptr" = alloca ptr, align 8
  store ptr %"closure-env:local2", ptr %"closure-env:local2-ptr", align 8
  %1 = load ptr, ptr %"closure-env:local2-ptr", align 8
  ...
  %3 = insertvalue { ptr, ptr, ptr, ptr } undef, ptr %"arg:base", 0
  %4 = insertvalue { ptr, ptr, ptr, ptr } %3, ptr %"arg:exponent", 1
  %5 = insertvalue { ptr, ptr, ptr, ptr } %4, ptr %0, 2
  %closure-arg = insertvalue { ptr, ptr, ptr, ptr } %5, ptr %1, 3
...
entry:
  %"closure-env:base" = extractvalue { ptr, ptr, ptr, ptr } %closure-env, 0
  %"closure-env:base-ptr" = alloca ptr, align 8
  store ptr %"closure-env:base", ptr %"closure-env:base-ptr", align 8
  %0 = load ptr, ptr %"closure-env:base-ptr", align 8
  %"closure-env:exponent" = extractvalue { ptr, ptr, ptr, ptr } %closure-env, 1
  %"closure-env:exponent-ptr" = alloca ptr, align 8
  store ptr %"closure-env:exponent", ptr %"closure-env:exponent-ptr", align 8
  %1 = load ptr, ptr %"closure-env:exponent-ptr", align 8
  %"closure-env:local" = extractvalue { ptr, ptr, ptr, ptr } %closure-env, 2
  %"closure-env:local-ptr" = alloca ptr, align 8
  store ptr %"closure-env:local", ptr %"closure-env:local-ptr", align 8
  %2 = load ptr, ptr %"closure-env:local-ptr", align 8
  %"closure-env:local2" = extractvalue { ptr, ptr, ptr, ptr } %closure-env, 3
  %"closure-env:local2-ptr" = alloca ptr, align 8
  store ptr %"closure-env:local2", ptr %"closure-env:local2-ptr", align 8
  %3 = load ptr, ptr %"closure-env:local2-ptr", align 8
  %"arg:exponent" = alloca i64, align 8
  store i64 %exponent, ptr %"arg:exponent", align 8
...
else_branch:                                      ; preds = %if_branch
  ...
  %closure-arg = insertvalue { ptr, ptr, ptr, ptr } %16, ptr %3, 3
